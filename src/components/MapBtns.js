...
const MapBtns = ({ count, geolocate, sideBarOpen, toggleSidebar }) => (
    ...
    >
      ...
      >
        <path d='M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94
          ...
          7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7
